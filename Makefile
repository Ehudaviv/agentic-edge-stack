...
all: clean up test test-cluster stress chaos
	...
	@echo "  - Local Mock FastAPI tests  : PASS"
	@echo "  - Cluster NodePort E2E tests: PASS"
	@echo "  - Locust 100-user Load tests: PASS"
	@echo "  - Chaos injection resiliency: PASS"
	@echo "========================================================="
	@echo "Access URLs & Admin Credentials:"
	...
	@echo "    - Username        : admin"
	@echo "    - Get Password    : kubectl -n argocd get secret argocd-initial-admin-secret -o jsonpath=\"{.data.password}\" | base64 --decode ; echo"
	@echo "  - Grafana Dashboard : http://localhost:30030"
	@echo "    - Username        : admin"
	@echo "    - Get Password    : kubectl -n monitoring get secret prometheus-grafana -o jsonpath=\"{.data.admin-password}\" | base64 --decode ; echo"
	@echo "========================================================="
